...
const driverStocks = [
  { code: "NVDA", name: "英伟达", weight: 7.95, change: 3.10 },
  { code: "AAPL", name: "苹果", weight: 8.72, change: 1.20 },
            ...
            <div className="rounded-3xl border border-stone-200/80 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.04)] sm:p-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="mt-3 flex items-center gap-3 text-sm font-medium">
                    <span className="text-emerald-700">+125.32</span>
                    <span className="text-emerald-700">+0.63%</span>
                  </div>
                </div>
              ...
              <div className="mt-6 border-t border-stone-200 pt-5 text-sm text-slate-500">
                <div className="flex justify-between py-1">
                  <span>主要驱动</span>
                  <span className="text-slate-700">英伟达</span>
                </div>
                <div className="flex justify-between py-1">
                  <span>上涨家数</span>
                ...
                <div className="flex justify-between py-1">
                  <span>观察节奏</span>
                  <span className="text-slate-700">美股开盘：夏令时 21:30 / 冬令时 22:30</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-3 space-y-1 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={getContributionColor(stock.change)}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`font-medium ${getContributionColor(stock.contribution)}`}>
